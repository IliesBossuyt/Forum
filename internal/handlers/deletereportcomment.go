...
type deleteCommentReportRequest struct {
	ReportID int `json:"report_id"`
}

// Gère la suppression d'un signalement de commentaire
func DeleteReportComment(w http.ResponseWriter, r *http.Request) {
	...
	var req deleteCommentReportRequest
	...
	err := models.DeleteCommentReportByID(req.ReportID)
	if err != nil {
